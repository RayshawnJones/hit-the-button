...
//         const audio = document.createElement('audio'); //first line const audio = document.createElement('audio'); creates a new HTML audio element. This
...
//         image.style.top = '0'; //sixth line image.style.top = '0'; sets the top of the image to 0 pixels from the top of the page.
//         image.style.left = '0'; //seventh line image.style.left = '0'; sets the left of the image to 0 pixels from the left of the page.
